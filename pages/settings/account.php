...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    if(isset($_POST["siteStatus"]))
    {
        ...
        {
            $arrayvalues["statusID"] = "2";
            fupdateobject("site", $arrayvalues, " where siteID = 1");
        }
        elseif($_POST["siteStatus"] == "2")
        {
            $arrayvalues["statusID"] = "1";
            fupdateobject("site", $arrayvalues, " where siteID = 1");
        }
...
<div class="wrapper bg-white mt-sm-5">
    ...
    <div class="py-2">
        ...
        <form action="The-better.great-site.net/index.php?path=settings&page=account" method="POST">
        <div class="row py-2">
            <div class="col-md-6">
