...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 18 dec 2022 om 14:47
...
INSERT INTO `menuitems` (`menuitemID`, `name`, `weight`, `icon`, `path`, `homepage`) VALUES
(1, 'Gebruikers', 1, '<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"100%\" height=\"100%\" fill=\"currentColor\" class=\"bi bi-people-fill\" viewBox=\"0 0 16 16\">\r\n    <path d=\"M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z\"/>\r\n    </svg>', 'users', 'userlist'),
...
--
ALTER TABLE `userid_menuitemid`
  MODIFY `userID_menuitemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
